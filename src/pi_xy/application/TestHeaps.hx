...
class TestHeaps extends hxd.App {
    ...
    override function init() {
        ...
        var heapsTileTest: hxd.Tile = pixelImage.heapsTile;
        var pixelImageTest = Pixelimage.heapsTile.createPixelImage( heapsTileTest );
        var tile = pixelImageTest.heapsTile;
